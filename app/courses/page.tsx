...
export default function Courses(){
  ...
  names={["Barret Croft","Dara Murphy"]} />
	...
	<CourseCards fakeprice="175" price="125" time="10" title="5th year revision course part I" points={["Atomic structure/the atom","electronic structure of the atom","ionic and covalent bonding and","stoichiometry"]} titledesc='Theory and exam questions/calculations' reviewsCount='21' reviews={["Chemistry School of Growth offers a refreshingly effective approach to chemistry education. The sessions are well-organized, and Lena's ability to communicate complex ideas with simplicity has made a substantial difference in my understanding of the subject","I enrolled in Kadri's online chemistry sessions with high expectations, and I was not disappointed. Lena's teaching style is engaging, and her proficiency in simplifying complex concepts has proven crucial in my learning journey."]} names={["Kian Ryan","Grainne Walsh"]} stars={5.0}/>

	<CourseCards fakeprice="175" price="125" time="10" title="5th year revision course part II/Experiment course part I" points={["acid and bases","acid-base titrations/volumetric analysis","redox volumetric","oxidation and reduction"]} titledesc='Calculation course only.' reviewsCount='16'reviews={["I'm so grateful for the Chemistry School of Growth. The study tips have been a lifesaver during exam season.","Among the online chemistry tutors I've tried, Chemistry School of Growth is my top choice. The sessions are simple and effective, making it my preferred option for extra learning."]} names={["Winnifred Mark","Grainne Murphy"]} stars={3.5} />
