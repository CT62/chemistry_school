...
export default function Header(){
    return(
    <header>
        <nav className="z-10 w-full absolute bg-opacity-30">
                ...
                <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
                    ...
                    <div className="relative z-20 w-full flex justify-between lg:w-max md:px-0">
                        <a href="#home" aria-label="logo" className="flex space-x-2 items-center">
                            <span className="text-2xl font-bold text-white">C.S.G</span>
                        </a>
                    ...
                    <div aria-hidden="true" className="fixed z-10 inset-0 h-screen w-screen bg-white backdrop-blur-2xl origin-bottom scale-y-0 transition duration-500 peer-checked:origin-top peer-checked:scale-y-100 lg:hidden bg-white"></div>
                    <div className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
                                ...
                                bg-cyan-500 bg-opacity-30 border-white">
                    
                        <div className="text-white lg:pr-4 lg:w-auto w-full lg:pt-0 font-extrabold">
